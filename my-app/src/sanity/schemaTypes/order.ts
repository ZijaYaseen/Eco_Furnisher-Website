              ...
              of: [
                {
                  ...
                  fields: [
                    ...
                    { name: 'variantImage', title: 'Image', type: 'string', description: 'Image URL for the variant' },
                  ],
                },
              ],
              description: 'Different variants of the product, each with its own vid , image , quantity and subtotal',
            },
